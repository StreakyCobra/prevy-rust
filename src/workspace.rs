...
/// kind `NotInWorkspace`.
pub fn cd_workspace_root() -> Result<()> {
    let workspace_root = try!(find_workspace_root());
...
/// `IO`.
fn current_dir<'a>() -> Result<String> {
